...
export default function StorySection() {
    return (
        <section id="our-story" className="py-24 bg-white relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-jookies-primary/5 rounded-full blur-3xl opacity-50 -translate-x-1/3 translate-y-1/3" />
                    ...
                    <div className="order-2 md:order-1 relative">
                        <div className="relative aspect-[4/5] w-full rounded-2xl overflow-hidden shadow-2xl rotate-2 hover:rotate-0 transition-transform duration-500">
                            ...
                            <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md p-6 rounded-xl shadow-lg">
                                <p className="font-heading text-lg text-jookies-text">&quot;No vendemos galletas, entregamos felicidad.&quot;</p>
                                <p className="text-sm text-jookies-text/60 mt-2">- El Equipo Jookies</p>
                            </div>
                        </div>
                        {/* Decorative elements */}
                        <div className="absolute -top-10 -left-10 w-20 h-20 bg-jookies-primary rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
                        <div className="absolute -bottom-10 -right-10 w-20 h-20 bg-jookies-secondary rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
                    </div>

                    <div className="order-1 md:order-2 space-y-8">
                        <div className="inline-block">
                            <h2 className="font-heading text-4xl md:text-5xl font-bold text-jookies-text leading-tight">
                                El Secreto está en el <span className="text-jookies-primary relative inline-block">
                                    Corazón
                        ...
                        <div className="prose prose-lg text-jookies-text/70">
                            <p>
                        ...
                        <div className="pt-4">
                            <button className="text-jookies-primary font-bold text-lg hover:underline decoration-2 underline-offset-4 group flex items-center gap-2">
